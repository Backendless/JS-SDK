...
describe('<Transactions> Add Relations Operation', function() {
  ...
  describe('Signatures', () => {
    describe('3 arguments;', () => {
      ...
      describe('parent:<Create.OpResult>', () => {
        ...
        async function check(children) {
          const opResult = uow.addToRelation(parentOpResult, ORDER_COLUMN, children)
        ...
        it('children:String', async () => {
          ...
          expect(opResult.result).to.equal(opResult.getResult()).to.equal(results.add_relationPerson1.result)
        })
      ...
      describe('parent:<Find.OpResultValue>', () => {
        ...
        async function check(children) {
          const opResult = uow.addToRelation(parentOpResult.resolveTo(3), ORDER_COLUMN, children)
      ...
      describe('parent:<Class>', () => {
        ...
        async function check(children) {
          const opResult = uow.addToRelation(parent, ORDER_COLUMN, children)
    ...
    describe('4 arguments;', () => {
      describe('parent:<ObjectId>', () => {
        ...
        async function check(children) {
          const opResult = uow.addToRelation(PERSONS_TABLE_NAME, parent, ORDER_COLUMN, children)
  ...
  describe('Fails', () => {
    ...
    it('has invalid parameters count', async () => {
      expect(() => uow.addToRelation()).to.throw(invalidArgsError)
      expect(() => uow.addToRelation('str')).to.throw(invalidArgsError)
    })
    ...
    it('the first argument is not an instance of [OpResult|OpResultValueReference|Object]', async () => {
      ...
      expect(() => uow.addToRelation(undefined, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(null, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(false, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(true, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(0, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(123, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation('str', ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(() => ({}), ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
    })
    ...
    it('the second argument is not either an Object or objectId', async () => {
      ...
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, undefined, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, null, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, false, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, true, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, 0, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, 123, ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, () => ({}), ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
    })
    ...
    it('table name is not a string', async () => {
      ...
      expect(() => uow.addToRelation(undefined, 'parent-id', ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(null, 'parent-id', ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(true, 'parent-id', ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(123, 'parent-id', ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation({}, 'parent-id', ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation([], 'parent-id', ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(() => ({}), 'parent-id', ORDER_COLUMN, 'child-id')).to.throw(errorMsg)
    })
    ...
    it('relation column is not valid', async () => {
      ...
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, 'parent-id', undefined, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, 'parent-id', null, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, 'parent-id', false, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, 'parent-id', true, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, 'parent-id', 0, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, 'parent-id', 123, 'child-id')).to.throw(errorMsg)
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, 'parent-id', () => ({}), 'child-id')).to.throw(errorMsg)
    })
    ...
    it('neither "unconditional" nor "conditional" parameter is specified', async () => {
      ...
      expect(() => uow.addToRelation(PERSONS_TABLE_NAME, 'parent-id', ORDER_COLUMN, '')).to.throw(errorMsg)
    })
  })
})
