...
describe('Transactions - Set 1:N Relations Operations', function() {
  ...
  describe('API Signatures', function() {
    ...
    describe('3 arguments;', function() {
      ...
      describe('parent:<Create.OpResult>', function() {
        ...
        async function checkResult(children) {
          const setRelationOp = uow.setRelation(createPersonOperation, ADDRESSES_COLUMN, children)
          ...
          expect(uowResult.results.set_relationPerson1.result).to.equal(2)
      ...
      describe('parent:<Update.OpResult>', function() {
        ...
        async function checkResult(children) {
          const setRelationOp = uow.setRelation(updatePersonOperation, ADDRESSES_COLUMN, children)
      ...
      describe('parent:<Find.OpResultValue>', function() {
        ...
        async function checkResult(children) {
          const setRelationOp = uow.setRelation(findPersonsOperation.resolvedTo(0), ADDRESSES_COLUMN, children)
      ...
      describe('parent:<BulkCreate.OpResultValue>', function() {
        ...
        async function checkResult(children) {
          const setRelationOp = uow.setRelation(bulkCreateOperation.resolvedTo(0), ADDRESSES_COLUMN, children)
      ...
      describe('parent:<Class>', function() {
        ...
        async function checkResult(children) {
          ...
          const setRelationOp = uow.setRelation(savedPerson, ADDRESSES_COLUMN, children)
    ...
    describe('4 arguments;', function() {
      ...
      describe('parent:<ObjectId>', function() {
        async function checkResult(children) {
          const setRelationOp = uow.setRelation(PERSONS_TABLE_NAME, savedPerson.objectId, ADDRESSES_COLUMN, children)
      ...
      describe('parent:<Class>', function() {
        ...
        async function checkResult(children) {
          ...
          const setRelationOp = uow.setRelation(PERSONS_TABLE_NAME, savedPerson, ADDRESSES_COLUMN, children)
      ...
      describe('parent:<HashMap>', function() {
        ...
        async function checkResult(children) {
          const setRelationOp = uow.setRelation(PERSONS_TABLE_NAME, { objectId: savedPerson.objectId }, ADDRESSES_COLUMN, children)
