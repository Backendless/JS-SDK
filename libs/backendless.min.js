...
null,!1):b.detachEvent?b.detachEvent("on"+a,null):b[a]=null};g.forEach=function(a,b,c){if(a)if(T&&a.forEach===T)a.forEach(b,c);else if(a.length===+a.length)for(var d=0,f=a.length;d<f&&!(d in a&&b.call(c,a[d],d,a)===breaker);d++);else for(d in a)if(ba.call(a,d)&&b.call(c,a[d],d,a)===breaker)break};e.setUIState=function(a){if(void 0===a)throw Error("UI state name must be defined or explicitly set to null");x=null===a?null:a};e._ajax_for_browser=function(a){var b=["cacheOnly","remoteDataOnly","fromCacheOrRemote",
...
"application/x-www-form-urlencoded","application-id":e.applicationId,"secret-key":e.secretKey,"application-type":"JS"}},f="";null!=q&&q["user-token"]&&(d.headers["user-token"]=q["user-token"]);if(a.isAsync)b=require(b).request(d,function(b){b.setEncoding("utf8");b.on("data",function(a){f+=a});b.on("end",function(){var c=a.asyncHandler[200<=b.statusCode&&300>b.statusCode?"success":"fault"];g.isFunction(c)&&c(f)})});else throw Error("Use Async type of request using Backendless with NodeJS. Add Backendless.Async(successCallback, errorCallback) as last argument");
...
return b.join(",")},U=function(a){var b=function(a){var b=null,c=null,e;for(e in a)if(a.hasOwnProperty(e)&&"___class"===e){b=a[e];break}if(b)try{c=eval(b),a=r(new c,a)}catch(h){}return a};if(g.isObject(a)&&null!=a)if(g.isArray(a))for(var c=a.length;c--;)a[c]=b(a[c]);else a=b(a);return a},r=function(a,b){for(var c in b)void 0!==b[c]&&b.hasOwnProperty(c)&&(a[c]=a[c]||{},a[c]=U(b[c]),a[c]&&(a[c].hasOwnProperty(c)&&a[c][c]&&a[c][c].hasOwnProperty("__originSubID"))&&(a[c][c]=U(a[c])));return a},l=function(a){var b,
c;b=0;for(c=a.length;b<c;++b)if(a[b]instanceof n)return a[b];return null};e.LocalCache=function(){var a={},b;a.enabled=!1;a.exists=function(a){};a.set=function(a,b){};a.get=function(a){};a.remove=function(a){};a.clear=function(){};a.flushExpired=function(){};a.getCachePolicy=function(a){};a.getAll=function(){};a.serialize=function(a){return JSON.stringify(a)};a.deserialize=function(a){if("string"==typeof a)try{return JSON.parse(a)}catch(b){return a||void 0}};if(function(){try{return m()&&"localStorage"in
...
return b};c();a.enabled=!0;a.exists=function(b){return void 0!==a.get(b)};a.set=function(d,e){if(void 0===e)return a.remove(d);c();var p=a.deserialize(b.getItem("Backendless"));"Object"==Object.prototype.toString.call(e).slice(8,-1)&&"cachePolicy"in e&&"timeToLive"in e.cachePolicy&&(e.cachePolicy.created=(new Date).getTime());p[d]=e;try{b.setItem("Backendless",a.serialize(p))}catch(h){p={},p[d]=e,b.setItem("Backendless",a.serialize(p))}return e};a.get=function(f){c();var e=a.deserialize(b.getItem("Backendless")),
p=e[f],h=p;d(p)&&(delete e[f],b.setItem("Backendless",a.serialize(e)),h=void 0);h&&h.cachePolicy&&delete h.cachePolicy;return h};a.remove=function(d){var e;c();d=d.replace(/([^A-Za-z0-9-])/g,"");var p=a.deserialize(b.getItem("Backendless"));p.hasOwnProperty(d)&&(e=delete p[d]);b.setItem("Backendless",a.serialize(p));return e};a.clear=function(){b.setItem("Backendless",a.serialize({}))};a.getAll=function(){c();var d=a.deserialize(b.getItem("Backendless")),e={},p;for(p in d)d.hasOwnProperty(p)&&(e[p]=
d[p],null!==e[p]&&e[p].hasOwnProperty("cachePolicy")&&delete e[p].cachePolicy);return e};a.flushExpired=function(){c();var f=a.deserialize(b.getItem("Backendless")),e,p;for(p in f)f.hasOwnProperty(p)&&(e=f[p],d(e)&&(delete f[p],b.setItem("Backendless",a.serialize(f))))};a.getCachePolicy=function(d){c();return(d=a.deserialize(b.getItem("Backendless"))[d])?d.cachePolicy:void 0}}return a}();e.LocalCache.enabled&&e.LocalCache.flushExpired();e.Async=n;u.prototype={addProperty:function(a){this.properties=
this.properties||[];this.properties.push(a)}};e.DataQuery=u;z.prototype={_extractQueryOptions:function(a){var b=[];if("undefined"!=typeof a.pageSize){if(1>a.pageSize||100<a.pageSize)throw Error("PageSize can not be less then 1 or greater than 100");b.push("pageSize="+encodeURIComponent(a.pageSize))}if("undefined"!=typeof a.offset){if(0>a.offset)throw Error("Offset can not be less then 0");b.push("offset="+encodeURIComponent(a.offset))}a.sortBy&&(g.isString(a.sortBy)?b.push("sortBy="+encodeURIComponent(a.sortBy)):
g.isArray(a.sortBy)&&b.push("sortBy="+C(a.sortBy)));a.relationsDepth&&g.isNumber(a.relationsDepth)&&b.push("relationsDepth="+encodeURIComponent(Math.floor(a.relationsDepth)));a.relations&&g.isArray(a.relations)&&b.push("loadRelations="+(a.relations.length?C(a.relations):"*"));return b.join("&")},_wrapAsync:function(a){var b=this;return new n(function(c){c=b._parseResponse(c);a.success(c)},function(b){a.fault(b)})},_parseResponse:function(a){var b=this.model;a=a.fields||a;b=new b;m()||(a=JSON.parse(a));
t(a,this);r(b,a);return this._formCircDeps(b)},_parseFindResponse:function(a){var b,c=this.model,d;if(a.data){var f=a,e=f.data;a=0;for(b=e.length;a<b;++a)e[a]=e[a].fields||e[a],d=new c,r(d,e[a]),e[a]=d;t(f,this);return f}a=a.fields||a;d=g.isString(c)?{}:new c;r(d,a);return this._formCircDeps(d)},_load:function(a,b){if(a){var c=l(arguments),d=!1;null!=c&&(d=!0,c=this._wrapAsync(c));c=e._ajax({method:"GET",url:a,isAsync:d,asyncHandler:c});return d?c:this._parseResponse(c)}},_replCircDeps:function(a){var b=
[a],c,d=function(a){for(var e in a)if(a.hasOwnProperty(e)&&"object"==typeof a[e]&&null!=a[e])if(-1!=(c=b.indexOf(a[e]))){var p=b[c],h;if(!(h=b[c].__subID))for(var v=h="";36>v++;h+=51*v?(v^15?8^Math.random()*(v^20?16:4):4).toString(16):"-");p.__subID=h;a[e]={__originSubID:b[c].__subID}}else g.isDate(a[e])?a[e]=a[e].getTime():(b.push(a[e]),d(a[e]))};d(a)},_formCircDeps:function(a){var b={},c=new a.constructor,d=function(a,c){a.hasOwnProperty("__subID")&&(b[a.__subID]=c,delete a.__subID);for(var e in a)a.hasOwnProperty(e)&&
...
typeof c)throw Error("You can use only String as timeToLive attribute to put into Cache");g.isObject(b)&&b.constructor!==Object&&(b.___class=b.___class||A.call(b));d=l([d]);var f=!1;null!=d&&(f=!0,d=this._wrapAsync(d));return e._ajax({method:"PUT",url:e.serverURL+"/"+e.appVersion+"/cache/"+a+(c?"?timeout="+c:""),data:JSON.stringify(b),isAsync:f,asyncHandler:d})},expireIn:function(a,b,c){if(g.isString(a)&&(g.isNumber(b)||g.isDate(b))&&b){b=g.isDate(b)?b.getTime():b;var d=l(arguments),f=!1;null!=d&&
(f=!0,d=this._wrapAsync(d));return e._ajax({method:"PUT",url:e.serverURL+"/"+e.appVersion+"/cache/"+a+"/expireIn?timeout="+b,data:JSON.stringify({}),isAsync:f,asyncHandler:d})}throw Error('The "key" argument must be String. The "seconds" argument can be either Number or Date');},expireAt:function(a,b,c){if(g.isString(a)&&(g.isNumber(b)||g.isDate(b))&&b){b=g.isDate(b)?b.getTime():b;var d=l(arguments),f=!1;null!=d&&(f=!0,d=this._wrapAsync(d));return e._ajax({method:"PUT",url:e.serverURL+"/"+e.appVersion+
"/cache/"+a+"/expireAt?timestamp="+b,data:JSON.stringify({}),isAsync:f,asyncHandler:d})}throw Error("You can use only String as key while expire in Cache. Second attribute must be declared and must be a Number or Date type");},cacheMethod:function(a,b,c,d){if(!g.isString(b))throw Error('The "key" argument must be String');var f=l(arguments),k=!1;null!=f&&(k=!0,f=this._wrapAsync(f));return e._ajax({method:a,url:e.serverURL+"/"+e.appVersion+"/cache/"+b+(c?"/check":""),isAsync:k,asyncHandler:f})},contains:function(a,
b){return this.cacheMethod("GET",a,!0,b)},get:function(a,b){if(!g.isString(a))throw Error('The "key" argument must be String');var c=l(arguments),d=!1;null!=c&&(d=!0,c=this._wrapAsync(c));c=e._ajax({method:"GET",url:e.serverURL+"/"+e.appVersion+"/cache/"+a,isAsync:d,asyncHandler:c});if(g.isObject(c)&&c.___class){var f;try{f=new (eval(c.___class))(c)}catch(k){f=new Y[c.___class](c)}return f}return c},remove:function(a,b){return this.cacheMethod("DELETE",a,!1,b)},setObjectFactory:function(a,b){Y[a]=
b}};var s=function(){},Z=function(a){this.name=a};s.prototype={_wrapAsync:function(a){var b=this;return new n(function(c){c=b._parseResponse(c);a.success(c)},function(b){a.fault(b)})},_parseResponse:function(a){return a},of:function(a){return new Z(a)},getConstructor:function(){return this},counterNameValidation:function(a,b){if(!a)throw Error('Missing value for the "counterName" argument. The argument must contain a string value.');if(!g.isString(a))throw Error('Invalid value for the "value" argument. The argument must contain only string values');
...
b,c)},getAndAdd:function(a,b,c){this.counterNameValidation(a,c);return this.implementMethodWithValue("/incrementby/get?value=",b,c)},compareAndSet:function(a,b,c,d){this.counterNameValidation(a,d);if(!b||!c)throw Error('Missing values for the "expected" and/or "updated" arguments. The arguments must contain numeric values');if(!g.isNumber(b)||!g.isNumber(c))throw Error('Missing value for the "expected" and/or "updated" arguments. The arguments must contain a numeric value');var f=l(arguments),k=!1;
null!=f&&(k=!0,f=this._wrapAsync(f));return e._ajax({method:"PUT",url:e.serverURL+"/"+e.appVersion+"/counters/"+this.name+"/get/compareandset?expected="+(b&&c?b+"&updatedvalue="+c:""),isAsync:k,asyncHandler:f})}};Z.prototype={incrementAndGet:function(a){return s.prototype.getConstructor().incrementAndGet(this.name,a)},getAndIncrement:function(a){return s.prototype.getConstructor().getAndIncrement(this.name,a)},decrementAndGet:function(a){return s.prototype.getConstructor().decrementAndGet(this.name,
