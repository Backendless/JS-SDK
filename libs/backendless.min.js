(function(){function m(){return"undefined"!==typeof window}function t(a,b){void 0!==a.nextPage&&(a.nextPage&&a.nextPage.split("/")[1]==e.appVersion&&(a.nextPage=e.serverURL+a.nextPage),a._nextPage=a.nextPage,a.nextPage=function(a){return b._load(this._nextPage,a)},a.getPage=function(a,d,f){var k=this._nextPage.replace(/offset=\d+/ig,"offset="+a);d instanceof n?f=d:k=k.replace(/pagesize=\d+/ig,"pageSize="+d);f=l(arguments);return b._load(k,f)},a.dataMapper=b)}function n(a,b,c){b instanceof Function||
(c=b,b=w);this.success=function(b){a&&a.call(c,b)};this.fault=function(a){b&&b.call(c,a)}}function u(){this.properties=[];this.url=this.options=this.condition=null}function z(a){this.model=g.isString(a)?function(){}:a;this.className=A.call(a);"string"===(typeof a).toLowerCase()&&(this.className=a);if(!this.className)throw"Class name should be specified";this.restUrl=e.appPath+"/data/"+this.className}function J(){this.restUrl=e.appPath+"/data";this.getRestUrl=function(a,b){return this.restUrl+"/"+
encodeURIComponent(a.___class)+"/permissions/"+encodeURIComponent(b)+"/"+encodeURIComponent(a.objectId)};this.sendRequest=function(a,b,c,d,f,k){var p=l(arguments),h=null!=p,g={permission:d};if(!c.___class||!c.objectId)throw Error('"dataObject.___class" and "dataObject.objectId" need to be specified');a?g.user=a:b&&(g.role=b);return e._ajax({method:"PUT",url:this.getRestUrl(c,f),data:JSON.stringify(g),isAsync:h,asyncHandler:p})}}function K(){}function L(){this.restUrl=e.appPath+"/geo";this.monitoringId=
null}function D(){}function E(a){this.eventHandlers={};this.restUrl=a;this.timeout=this.timer=0;this.interval=1E3;this.xhr=null;this.needReconnect=!0;this.responder=new n(this.onMessage,this.onError,this);this.poll()}function F(a){var b=this;this.reconnectWithPolling=!0;try{var c=this.socket=new M(a);c.onopen=function(){return b.sockOpen()};c.onerror=function(a){return b.sockError(a)};c.onclose=function(a){b.onSocketClose()};c.onmessage=function(a){return b.onMessage(a)}}catch(d){setTimeout(function(){b.onSocketClose()},
...
"\r\n";d+=b;d+="\r\n";d+="--";d+=c;d+="--";return d+="\r\n"}function $(a){var b=new XMLHttpRequest,c="-backendless-multipart-form-boundary-"+(new Date).getTime();a=O(this.fileName,a.target.result,c);b.open("POST",this.uploadPath,!0);b.setRequestHeader("content-type","multipart/form-data; boundary="+c);b.setRequestHeader("application-id",e.applicationId);b.setRequestHeader("secret-key",e.secretKey);b.setRequestHeader("application-type","JS");null!==x&&b.setRequestHeader("uiState",x);var d=this.asyncHandler;
d&&(b.onreadystatechange=function(){4==b.readyState&&(200<=b.status&&300>b.status?d.success(JSON.parse(b.responseText)):d.fault(JSON.parse(b.responseText)))});b.sendAsBinary(a);if(d)return b;if(200<=b.status&&300>b.status)return b.responseText?JSON.parse(b.responseText):!0;throw function(a){var b={};try{b=JSON.parse(a.responseText)}catch(c){b.message=a.responseText}b.statusCode=a.status;return b}(b);}function aa(a){var b=new XMLHttpRequest,c="-backendless-multipart-form-boundary-"+(new Date).getTime();
O(this.fileName,a.target.result,c);b.open("PUT",this.uploadPath,!0);b.setRequestHeader("Content-Type","text/plain");b.setRequestHeader("application-id",e.applicationId);b.setRequestHeader("secret-key",e.secretKey);b.setRequestHeader("application-type","JS");null!==x&&b.setRequestHeader("uiState",x);var d=this.asyncHandler;d&&(b.onreadystatechange=function(){4==b.readyState&&(200<=b.status&&300>b.status?d.success(JSON.parse(b.responseText)):d.fault(JSON.parse(b.responseText)))});b.send(a.target.result.split(",")[1]);
if(d)return b;if(200<=b.status&&300>b.status)return b.responseText?JSON.parse(b.responseText):!0;throw function(a){var b={};try{b=JSON.parse(a.responseText)}catch(c){b.message=a.responseText}b.statusCode=a.status;return b}(b);}function P(){this.restUrl=e.appPath+"/files/permissions"}function Q(){this.restUrl=e.appPath+"/files"}function B(){this.restUrl=e.appPath+"/commerce/googleplay"}function H(){this.restUrl=e.appPath+"/servercode/events"}function R(a){this.name=a}function y(a,b,c,d){var f={};f.message=
c;f.timestamp=Date.now();f.exception=d?d:null;f.logger=a;f["log-level"]=b;e.Logging.logInfo.push(f);e.Logging.messagesCount++;e.Logging.checkMessagesLen()}function S(){}NodeDevice={name:"NODEJS",platform:"NODEJS",uuid:"someId",version:"1"};m()||(encodeURIComponent=function(a){return escape(a)});var e=this.Backendless||{},w=function(){};this.Backendless=e;Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var c;if(null==this)throw new TypeError('"this" is null or not defined');var d=Object(this),
f=d.length>>>0;if(0===f)return-1;c=+b||0;Infinity===Math.abs(c)&&(c=0);if(c>=f)return-1;for(c=Math.max(0<=c?c:f-Math.abs(c),0);c<f;){if(c in d&&d[c]===a)return c;c++}return-1});var ba=Object.prototype.hasOwnProperty,T=Array.prototype.forEach,ca=Array.isArray,M=null;e.VERSION="0.2";e.serverURL="https://api.backendless.com";(function(){try{"undefined"==typeof XMLHttpRequest.prototype.sendAsBinary&&(XMLHttpRequest.prototype.sendAsBinary=function(a){for(var c=new ArrayBuffer(a.length),c=new Uint8Array(c,
0),d=0;d<a.length;d++)c[d]=a.charCodeAt(d)&255;this.send(c)})}catch(a){}})();var da=function(){var a=m()?navigator.userAgent.toLowerCase():"NodeJS",b=/(chrome)[ \/]([\w.]+)/.exec(a)||/(webkit)[ \/]([\w.]+)/.exec(a)||/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(a)||/(msie) ([\w.]+)/.exec(a)||0>a.indexOf("compatible")&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(a)||[],a=b[1]||"",b=b[2]||"0",c={};a&&(c[a]=!0,c.version=b);return c}(),x=null;e.browser=da;var g=e.Utils={isObject:function(a){return a===Object(a)},
...
-1)};g.addEvent=function(a,b,c){b.addEventListener?b.addEventListener(a,c,!1):b.attachEvent?b.attachEvent("on"+a,c):b[a]=c};g.isEmpty=function(a){if(null==a)return!0;if(g.isArray(a)||g.isString(a))return 0===a.length;for(var b in a)if(a.hasOwnProperty(b)&&void 0!==a[b]&&null!==a[b])return!1;return!0};g.removeEvent=function(a,b){b.removeEventListener?b.removeEventListener(a,null,!1):b.detachEvent?b.detachEvent("on"+a,null):b[a]=null};g.forEach=function(a,b,c){if(a)if(T&&a.forEach===T)a.forEach(b,c);
else if(a.length===+a.length)for(var d=0,f=a.length;d<f&&!(d in a&&b.call(c,a[d],d,a)===breaker);d++);else for(d in a)if(ba.call(a,d)&&b.call(c,a[d],d,a)===breaker)break};e.setUIState=function(a){if(void 0===a)throw Error("UI state name must be defined or explicitly set to null");x=null===a?null:a};e._ajax_for_browser=function(a){var b=["cacheOnly","remoteDataOnly","fromCacheOrRemote","fromRemoteOrCache","fromCacheAndRemote"],c={ignoreCache:function(a){return d(a)},cacheOnly:function(a){var b=e.LocalCache.get(a.url.replace(/([^A-Za-z0-9])/g,
...
a.responseText}b.statusCode=a.status;b.message=b.message||"unknown error occurred";return b},m=function(b){b=g.isArray(b)?b.slice():r({},b);"GET"==a.method&&a.cacheActive?(b.cachePolicy=a.cachePolicy,e.LocalCache.set(a.urlBlueprint,b)):e.LocalCache.exists(a.urlBlueprint)&&(!0===b||"DELETE"==a.method?b=void 0:b.cachePolicy=e.LocalCache.getCachePolicy(a.urlBlueprint),"___class"in b&&delete b.___class,e.LocalCache.set(a.urlBlueprint,b))},n=function(){return a.cacheActive&&"fromRemoteOrCache"==a.cachePolicy.policy&&
...
b.readyState&&(200<=b.status&&300>b.status?(d=f(b),m(d),a.asyncHandler.success&&a.asyncHandler.success(d)):n()?a.asyncHandler.success&&a.asyncHandler.success(e.LocalCache.get(a.urlBlueprint)):a.asyncHandler.fault&&a.asyncHandler.fault(l(b)))});b.send(a.data);if(a.isAsync)return b;if(200<=b.status&&300>b.status)return d=f(b),m(d),d;if(n())return e.LocalCache.get(a.urlBlueprint);throw l(b);};a.method=a.method||"GET";a.cachePolicy=a.cachePolicy||{policy:"ignoreCache"};a.isAsync="boolean"==typeof a.isAsync?
...
q["user-token"]);if(a.isAsync)b=require(b).request(d,function(b){b.setEncoding("utf8");b.on("data",function(a){f+=a});b.on("end",function(){var c=a.asyncHandler[200<=b.statusCode&&300>b.statusCode?"success":"fault"];g.isFunction(c)&&c(f)})});else throw Error("Use Async type of request using Backendless with NodeJS. Add Backendless.Async(successCallback, errorCallback) as last argument");b.on("error",function(b){a.asyncHandler.fault||(a.asyncHandler.fault=function(){});a.asyncHandler.fault(b)});b.write(a.data,
"utf8");return b.end()};e._ajax=m()?e._ajax_for_browser:e._ajax_for_nodejs;var A=function(){if(this.prototype&&this.prototype.___class)return this.prototype.___class;var a=(g.isFunction(this)?this.toString():this.constructor.toString()).match(/function\s+(\w+)/);return a&&1<a.length?a[1]:""},C=function(a){var b=[],c,d;c=0;for(d=a.length;c<d;++c)b.push(encodeURIComponent(a[c]));return b.join(",")},U=function(a){var b=function(a){var b=null,c=null,e;for(e in a)if(a.hasOwnProperty(e)&&"___class"===e){b=
a[e];break}if(b)try{c=eval(b),a=r(new c,a)}catch(h){}return a};if(g.isObject(a)&&null!=a)if(g.isArray(a))for(var c=a.length;c--;)a[c]=b(a[c]);else a=b(a);return a},r=function(a,b){for(var c in b)void 0!==b[c]&&b.hasOwnProperty(c)&&(a[c]=a[c]||{},a[c]=U(b[c]),a[c]&&(a[c].hasOwnProperty(c)&&a[c][c]&&a[c][c].hasOwnProperty("__originSubID"))&&(a[c][c]=U(a[c])));return a},l=function(a){var b,c;b=0;for(c=a.length;b<c;++b)if(a[b]instanceof n)return a[b];return null};e.LocalCache=function(){var a={},b;a.enabled=
...
c();var p=a.deserialize(b.getItem("Backendless"));"Object"==Object.prototype.toString.call(e).slice(8,-1)&&"cachePolicy"in e&&"timeToLive"in e.cachePolicy&&(e.cachePolicy.created=(new Date).getTime());p[d]=e;try{b.setItem("Backendless",a.serialize(p))}catch(h){p={},p[d]=e,b.setItem("Backendless",a.serialize(p))}return e};a.get=function(f){c();var e=a.deserialize(b.getItem("Backendless")),p=e[f],h=p;d(p)&&(delete e[f],b.setItem("Backendless",a.serialize(e)),h=void 0);h&&h.cachePolicy&&delete h.cachePolicy;
return h};a.remove=function(d){var e;c();d=d.replace(/([^A-Za-z0-9-])/g,"");var p=a.deserialize(b.getItem("Backendless"));p.hasOwnProperty(d)&&(e=delete p[d]);b.setItem("Backendless",a.serialize(p));return e};a.clear=function(){b.setItem("Backendless",a.serialize({}))};a.getAll=function(){c();var d=a.deserialize(b.getItem("Backendless")),e={},p;for(p in d)d.hasOwnProperty(p)&&(e[p]=d[p],null!==e[p]&&e[p].hasOwnProperty("cachePolicy")&&delete e[p].cachePolicy);return e};a.flushExpired=function(){c();
var f=a.deserialize(b.getItem("Backendless")),e,p;for(p in f)f.hasOwnProperty(p)&&(e=f[p],d(e)&&(delete f[p],b.setItem("Backendless",a.serialize(f))))};a.getCachePolicy=function(d){c();return(d=a.deserialize(b.getItem("Backendless"))[d])?d.cachePolicy:void 0}}return a}();e.LocalCache.enabled&&e.LocalCache.flushExpired();e.Async=n;u.prototype={addProperty:function(a){this.properties=this.properties||[];this.properties.push(a)}};e.DataQuery=u;z.prototype={_extractQueryOptions:function(a){var b=[];if("undefined"!=
typeof a.pageSize){if(1>a.pageSize||100<a.pageSize)throw Error("PageSize can not be less then 1 or greater than 100");b.push("pageSize="+encodeURIComponent(a.pageSize))}if("undefined"!=typeof a.offset){if(0>a.offset)throw Error("Offset can not be less then 0");b.push("offset="+encodeURIComponent(a.offset))}a.sortBy&&(g.isString(a.sortBy)?b.push("sortBy="+encodeURIComponent(a.sortBy)):g.isArray(a.sortBy)&&b.push("sortBy="+C(a.sortBy)));a.relationsDepth&&g.isNumber(a.relationsDepth)&&b.push("relationsDepth="+
encodeURIComponent(Math.floor(a.relationsDepth)));a.relations&&g.isArray(a.relations)&&b.push("loadRelations="+(a.relations.length?C(a.relations):"*"));return b.join("&")},_wrapAsync:function(a){var b=this;return new n(function(c){c=b._parseResponse(c);a.success(c)},function(b){a.fault(b)})},_parseResponse:function(a){var b=this.model;a=a.fields||a;b=new b;m()||(a=JSON.parse(a));t(a,this);r(b,a);return this._formCircDeps(b)},_parseFindResponse:function(a){var b,c=this.model,d;if(a.data){var f=a,e=
f.data;a=0;for(b=e.length;a<b;++a)e[a]=e[a].fields||e[a],d=new c,r(d,e[a]),e[a]=d;t(f,this);return f}a=a.fields||a;d=g.isString(c)?{}:new c;r(d,a);return this._formCircDeps(d)},_load:function(a,b){if(a){var c=l(arguments),d=!1;null!=c&&(d=!0,c=this._wrapAsync(c));c=e._ajax({method:"GET",url:a,isAsync:d,asyncHandler:c});return d?c:this._parseResponse(c)}},_replCircDeps:function(a){var b=[a],c,d=function(a){for(var e in a)if(a.hasOwnProperty(e)&&"object"==typeof a[e]&&null!=a[e])if(-1!=(c=b.indexOf(a[e]))){var p=
b[c],h;if(!(h=b[c].__subID))for(var v=h="";36>v++;h+=51*v?(v^15?8^Math.random()*(v^20?16:4):4).toString(16):"-");p.__subID=h;a[e]={__originSubID:b[c].__subID}}else g.isDate(a[e])?a[e]=a[e].getTime():(b.push(a[e]),d(a[e]))};d(a)},_formCircDeps:function(a){var b={},c=new a.constructor,d=function(a,c){a.hasOwnProperty("__subID")&&(b[a.__subID]=c,delete a.__subID);for(var e in a)a.hasOwnProperty(e)&&("object"==typeof a[e]&&null!=a[e]?a[e].hasOwnProperty("__originSubID")?c[e]=b[a[e].__originSubID]:(c[e]=
new a[e].constructor,d(a[e],c[e])):c[e]=a[e])};d(a,c);return c},save:function(a,b){this._replCircDeps(a);var c=l(arguments),d=!1,f=this.restUrl,k=a;null!=c&&(d=!0,c=this._wrapAsync(c));c=e._ajax({method:"PUT",url:f,data:JSON.stringify(a),isAsync:d,asyncHandler:c});d||r(k,this._parseResponse(c));return d?c:this._parseResponse(c)},remove:function(a,b){if(!g.isObject(a)&&!g.isString(a))throw Error('Invalid value for the "value" argument. The argument must contain only string or object values');var c=
l(arguments),d=!1;null!=c&&(d=!0,c=this._wrapAsync(c));g.isString(a)||a.objectId?(a=a.objectId||a,c=e._ajax({method:"DELETE",url:this.restUrl+"/"+a,isAsync:d,asyncHandler:c})):c=e._ajax({method:"DELETE",url:this.restUrl,data:JSON.stringify(a),isAsync:d,asyncHandler:c});return d?c:this._parseResponse(c)},find:function(a){a=a||{};var b,c,d,f=[],k=this.restUrl,p=l(arguments),h=null!=p;a.properties&&a.properties.length&&(b="props="+C(a.properties));a.condition&&(c="where="+encodeURIComponent(a.condition));
a.options&&(d=this._extractQueryOptions(a.options));null!=p&&(p=this._wrapAsync(p));d&&f.push(d);c&&f.push(c);b&&f.push(b);f=f.join("&");a.url&&(k+="/"+a.url);f&&(k+="?"+f);b=e._ajax({method:"GET",url:k,isAsync:h,asyncHandler:p,cachePolicy:a.cachePolicy});return h?b:this._parseFindResponse(b)},_buildArgsObject:function(){for(var a={},b=arguments.length,c="";b--;)switch(c=Object.prototype.toString.call(arguments[b]).toLowerCase().match(/[a-z]+/g)[1],c){case "number":a.options=a.options||{};a.options.relationsDepth=
...
a.url="first";return this.find.apply(this,[a].concat(Array.prototype.slice.call(arguments)))},findLast:function(){var a=this._buildArgsObject.apply(this,arguments);a.url="last";return this.find.apply(this,[a].concat(Array.prototype.slice.call(arguments)))}};var I={},V={save:function(a,b,c){var d=l(arguments);if(g.isString(a))return e._ajax({method:"POST",url:e.appPath+"/data/"+a,data:JSON.stringify(b),isAsync:!1,asyncHandler:d});if(g.isObject(a))return(new z(a)).save(a,b,c)},getView:function(a,b,
c,d,f){var k=l(arguments),p=null!=k;if(g.isString(a)){var h=e.appPath+"/data/"+a;1<arguments.length&&!(arguments[1]instanceof e.Async)&&(h+="?");g.isString(b)?h+="where="+b:d=c=b;g.isNumber(c)&&(h+="&"+(new z)._extractQueryOptions({pageSize:c}));g.isNumber(d)&&(h+="&"+(new z)._extractQueryOptions({offset:d}));return e._ajax({method:"GET",url:h,isAsync:p,asyncHandler:k})}throw Error("View name is required string parameter");},callStoredProcedure:function(a,b,c){var d=l(arguments),f=null!=d;if(g.isString(a)){var k=
e.appPath+"/data/"+a,p={};g.isObject(b)&&(p=JSON.stringify(b));return e._ajax({method:"POST",url:k,data:p,isAsync:f,asyncHandler:d})}throw Error("Stored Procedure name is required string parameter");},of:function(a){var b;if(g.isString(a)){if("users"===a.toLowerCase())throw Error("Table 'Users' is not accessible through this signature. Use Backendless.Data.of( BackendlessUser.class ) instead");b=a}else b=A.call(a);var c=I[b];c||(c=new z(a),I[b]=c);return c},describe:function(a,b){a=g.isString(a)?
...
isAsync:c,asyncHandler:b});return c?b:this._parseResponse(b)},roleHelper:function(a,b,c,d){if(!a)throw Error("Username can not be empty");if(!b)throw Error("Rolename can not be empty");var f=l(arguments),k=null!=f;f&&(f=this._wrapAsync(f));return e._ajax({method:"POST",url:this.restUrl+"/"+d,isAsync:k,asyncHandler:f,data:JSON.stringify({user:a,roleName:b})})},assignRole:function(a,b,c){return this.roleHelper(a,b,c,"assignRole")},unassignRole:function(a,b,c){return this.roleHelper(a,b,c,"unassignRole")},
login:function(a,b,c,d){if(!a)throw Error("Username can not be empty");if(!b)throw Error("Password can not be empty");e.LocalCache.remove("user-token");e.LocalCache.remove("current-user-id");e.LocalCache.set("stayLoggedIn",!1);g.isBoolean(c)&&e.LocalCache.set("stayLoggedIn",c);var f=l(arguments),k=null!=f;f&&(f=this._wrapAsync(f));f=e._ajax({method:"POST",url:this.restUrl+"/login",isAsync:k,asyncHandler:f,data:JSON.stringify({login:a,password:b})});if(k)return f;q=this._parseResponse(f);return this._getUserFromResponse(q)},
...
arguments[1])},_getOutRectangleCircle:function(a,b){var c=this._distance(a.latitude,a.longitude,b.latitude,b.longitude),d=a.latitude+180*c/(Math.PI*this.EARTH_RADIUS)*(0<a.latitude?1:-1),e=this._countLittleRadius(d),k,g;e>c?(c=a.longitude-180*c/e,e=2*a.longitude-c,c=this._updateDegree(c),e=180==e%360?180:this._updateDegree(e)):(c=-180,e=180);0<a.latitude?(k=d,g=2*a.latitude-d):(g=d,k=2*a.latitude-d);return[Math.min(k,90),c,Math.max(g,-90),e]},_getOutRectangleNodes:function(a){for(var b=a[0].latitude,
c=a[0].longitude,d=a[0].latitude,e=a[0].longitude,k=0,g=0,h=0,l=1;l<a.length;l++){a[l].latitude>b&&(b=a[l].latitude);a[l].latitude<d&&(d=a[l].latitude);var m=a[l].latitude-a[l-1].latitude;if(0>m&&-180<m||270<m)270<m&&(m-=360),h+=m,h<k&&(k=h);else if(0<m&&180>=m||-270>=m)-270>=m&&(m+=360),h+=m,h>g&&(g=h)}c+=k;e+=g;360<=e-c?(e=180,c=-180):(e=this._updateDegree(e),c=this._updateDegree(c));return[b,c,d,e]},_getPointPosition:function(a,b,c){var d=c.longitude-b.longitude;if(0>d&&-180<d||180<d)d=b,b=c,c=
...
b.nodes)},_typesMapper:{RECT:function(a){a.nwPoint=a.nodes[0];a.sePoint=a.nodes[1]},CIRCLE:function(a,b){var c=b._getOutRectangle(a.nodes[0],a.nodes[1]);a.nwPoint={latitude:c[0],longitude:c[1]};a.sePoint={latitude:c[2],longitude:c[3]}},SHAPE:function(a,b){var c=b._getOutRectangle(a.nodes[0],a.nodes[1]);a.nwPoint={latitude:c[0],longitude:c[1]};a.sePoint={latitude:c[2],longitude:c[3]}}},_maxDuration:5E3,_timers:{},_checkPosition:function(a,b,c,d,e,k,g){var h=this;for(a=0;a<h._trackedFences.length;a++){var l=
h._isDefiniteRect(h._trackedFences[a].nwPoint,h._trackedFences[a].sePoint)&&h._isPointInFence(b,h._trackedFences[a]);c=null;l!=k[h._trackedFences[a].geofenceName]&&(c=k[h._trackedFences[a].geofenceName]?"onexit":"onenter",k[h._trackedFences[a].geofenceName]=l);if(c){var l=1E3*h._trackedFences[a].onStayDuration,m=function(a,b,c){h._timers[h._trackedFences[a].geofenceName]=setTimeout(function(){e.onstay(h._trackedFences[a].geofenceName,h._trackedFences[a].objectId,b.latitude,b.longitude)},c)},n=function(a,
b,c,d){h._timers[h._trackedFences[a].geofenceName]=setTimeout(function(){h._runFenceAction("onstay",h._trackedFences[a].geofenceName,d,g)},c)};if(e)if("onenter"==c)if(e[c](h._trackedFences[a].geofenceName,h._trackedFences[a].objectId,b.latitude,b.longitude),-1<l)m(a,b,l);else e.onstay(h._trackedFences[a].geofenceName,h._trackedFences[a].objectId,b.latitude,b.longitude);else clearTimeout(h._timers[h._trackedFences[a].geofenceName]),e[c](h._trackedFences[a].geofenceName,h._trackedFences[a].objectId,
b.latitude,b.longitude);else d&&(d.latitude=b.latitude,d.longitude=b.longitude,"onenter"==c?(h._runFenceAction(c,h._trackedFences[a].geofenceName,d,g),-1<l?n(a,b,l,d):h._runFenceAction("onstay",h._trackedFences[a].geofenceName,d,g)):(clearTimeout(h._timers[h._trackedFences[a].geofenceName]),h._runFenceAction(c,h._trackedFences[a].geofenceName,d,g)))}}},_mobilecheck:function(){var a=!1,b=navigator.userAgent||navigator.vendor||window.opera;if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(b)||
...
4)))a=!0;return a},_trackedFences:[],_lastResults:{},_startMonitoring:function(a,b,c){function d(a,b,c){for(var d=a.length,e=!1,f=0;f<d&&!(e=a[f][c]===b[c]);f++);return e}function e(d){h._checkPosition(a,d.coords,m,l?b:null,l?null:b,h._lastResults,c)}function k(a){throw Error("Error during current position calculation. Error "+a.message);}function g(){navigator.geolocation.getCurrentPosition(e,k,{timeout:5E3,enableHighAccuracy:!0})}var h=this;if(b instanceof GeoPoint)var l=!0;for(var m=this._getFences(a),
n=0;n<m.length;n++)d(h._trackedFences,m[n],"geofenceName")||(h._typesMapper[m[n].type](m[n],h),h._lastResults[m[n].geofenceName]=!1,h._trackedFences.push(m[n]));if(!this.monitoringId)if(m.length)this.monitoringId=this._mobilecheck()?navigator.geolocation.watchPosition(e,k,{timeout:h._maxDuration,enableHighAccuracy:!0}):setInterval(g,h._maxDuration);else throw Error("Please, add some fences to start monitoring");},startGeofenceMonitoringWithInAppCallback:function(a,b,c){this._startMonitoring(a,b,c)},
...
function(b){b.messages.length&&a.responder(b)})}};N.prototype={_getProperties:function(a,b){var c=l(arguments),d=null!=c,f=this.channelProperties[a];if(f)return d&&b.success(f),f;c=e._ajax({method:"GET",url:this.restUrl+"/"+a+"/properties",isAsync:d,asyncHandler:c});return this.channelProperties[a]=c},subscribe:function(a,b,c,d){var e=l(arguments);if(null!=e){var k=this,g=new n(function(h){d.success(new G({channelName:a,options:c,channelProperties:h,responder:b,restUrl:k.restUrl,onSubscribe:e}))},
function(a){e.fault(a)});this._getProperties(a,g)}else return g=this._getProperties(a),new G({channelName:a,options:c,channelProperties:g,responder:b,restUrl:this.restUrl})},publish:function(a,b,c,d,f){var k=l(arguments),g=null!=k,h={message:b};if(c){if(!(c instanceof PublishOptions))throw"Use PublishOption as publishOptions argument";r(h,c)}if(d){if(!(d instanceof DeliveryOptions))throw"Use DeliveryOptions as deliveryTarget argument";r(h,d)}return e._ajax({method:"POST",url:this.restUrl+"/"+a,isAsync:g,
asyncHandler:k,data:JSON.stringify(h)})},sendEmail:function(a,b,c,d,f){var k=l(arguments),m=null!=k,h={};if(a&&!g.isEmpty(a)&&g.isString(a))h.subject=a;else throw"Subject is required parameter and must be a nonempty string";if(b instanceof Bodyparts&&!g.isEmpty(b))h.bodyparts=b;else throw"Use Bodyparts as bodyParts argument, must contain at least one property";if(c&&g.isArray(c)&&!g.isEmpty(c))h.to=c;else throw"Recipients is required parameter, must be a nonempty array";if(d)if(g.isArray(d))g.isEmpty(d)||
(h.attachment=d);else throw"Attachments must be an array of file IDs from File Service";return e._ajax({method:"POST",url:this.restUrl+"/email",isAsync:m,asyncHandler:k,data:JSON.stringify(h)})},cancel:function(a,b){return e._ajax({method:"DELETE",url:this.restUrl+"/"+a,isAsync:null!=b,asyncHandler:new n(w)})},registerDevice:function(a,b,c){var d=l(arguments),f=null!=d,k=m()?window.device:NodeDevice,p={deviceToken:null,deviceId:k.uuid,os:k.platform,osVersion:k.version};g.isArray(a)&&(p.channels=a);
for(var k=0,h=arguments.length;k<h;++k){var n=arguments[k];if(g.isNumber(n)||n instanceof Date)p.expiration=n instanceof Date?n.getTime()/1E3:n}var q=this.restUrl+"/registrations";cordova.exec(function(a){p.deviceToken=a;e._ajax({method:"POST",url:q,data:JSON.stringify(p),isAsync:f,asyncHandler:d})},function(a){console.warn(JSON.stringify(["failed to register ",a]))},"PushNotification","registerDevice",[{projectid:"http://backendless.com",appid:e.applicationId}])},getRegistrations:function(a){var b=
...
this.id=a;return this.grant(b,c,d)},grantRole:function(a,b,c,d){this.varType="role";this.id=a;return this.grant(b,c,d)},grant:function(a,b,c){return this.sendRequest("GRANT",a,b,c)},denyUser:function(a,b,c,d){this.varType="role";this.id=a;return this.deny(b,c,d)},denyRole:function(a,b,c,d){this.varType="role";this.id=a;return this.deny(b,c,d)},deny:function(a,b,c){return this.sendRequest("DENY",a,b,c)},sendRequest:function(a,b,c,d){var f=l(arguments),k=null!=f,g={permission:c};g[this.varType]=this.id||
"*";return e._ajax({method:"PUT",url:this.restUrl+"/"+a+"/"+encodeURIComponent(b),data:JSON.stringify(g),isAsync:k,asyncHandler:f})}};Q.prototype={saveFile:function(a,b,c,d,f){if(!a||!g.isString(a))throw Error('Missing value for the "path" argument. The argument must contain a string value');if(!b||!g.isString(a))throw Error('Missing value for the "fileName" argument. The argument must contain a string value');d instanceof e.Async&&(f=d,d=null);c instanceof File||(c=new Blob([c]));if(28E5<c.size)throw Error("File Content size must be less than 2,800,000 bytes");
a=this.restUrl+"/binary/"+a+(g.isString(b)?"/"+b:"")+(d?"?overwrite=true":"");try{var k=new FileReader;k.fileName=b;k.uploadPath=a;k.onloadend=aa;f&&(k.asyncHandler=f);k.onerror=function(a){f.fault(a)};k.readAsDataURL(c);if(!f)return!0}catch(l){console.log(l)}},upload:function(a,b,c,d){a=a.files||a;b=this.restUrl+"/"+b+"/";if(g.isBoolean(c))var e="?overwrite="+c;if(m())if(window.File&&window.FileList){a instanceof File&&(a=[a]);for(var k=c=0,l=a.length;k<l;k++)try{var h=new FileReader;h.fileName=
a[k].name;h.uploadPath=b+h.fileName+(e?e:"");h.onloadend=$;h.asyncHandler=d;h.onerror=function(a){d.fault(a)};h.readAsBinaryString(a[k])}catch(n){c++}}else c=document.createElement("iframe"),c.id=c.name="ifr"+(new Date).getTime(),c.width=c.height="0",document.body.appendChild(c),h=document.createElement("form"),h.target=c.name,h.enctype="multipart/form-data",h.method="POST",document.body.appendChild(h),h.appendChild(a),a=a.value,(c=a.lastIndexOf("\\"))&&(a=a.substring(c+1)),h.action=b+a+(e?e:""),
h.submit();else throw"Upload File not supported with NodeJS";},listing:function(a,b,c,d,f,k){var m=l(arguments),h=null!=m,n=this.restUrl+"/"+a;1<arguments.length&&!(arguments[1]instanceof e.Async)&&(n+="?");g.isString(b)&&(n+="pattern="+b);g.isBoolean(c)&&(n+="&sub="+c);g.isNumber(d)&&(n+="&pagesize="+d);g.isNumber(f)&&(n+="&offset="+f);return e._ajax({method:"GET",url:n,isAsync:h,asyncHandler:m})},renameFile:function(a,b,c){this._checkPath(a);this._doAction("rename",{oldPathName:a,newName:b},c)},
moveFile:function(a,b,c){this._checkPath(a);this._checkPath(b);this._doAction("move",{sourcePath:a,targetPath:b},c)},copyFile:function(a,b,c){this._checkPath(a);this._checkPath(b);this._doAction("copy",{sourcePath:a,targetPath:b},c)},_checkPath:function(a){/^\//.test(a)||(a="/"+a);return a},_doAction:function(a,b,c){var d=l(arguments),f=null!=d;e._ajax({method:"PUT",url:this.restUrl+"/"+a,data:JSON.stringify(b),isAsync:f,asyncHandler:d})},remove:function(a,b){var c=l(arguments),d=null!=c,f=0==a.indexOf("http://")||
0==a.indexOf("https://")?a:this.restUrl+"/"+a;e._ajax({method:"DELETE",url:f,isAsync:d,asyncHandler:c})},exists:function(a,b){if(!a||!g.isString(a))throw Error('Missing value for the "path" argument. The argument must contain a string value');var c=l(arguments);return e._ajax({method:"GET",url:this.restUrl+"/exists/"+a,isAsync:null!=c,asyncHandler:c})},removeDirectory:function(a,b){var c=l(arguments);e._ajax({method:"DELETE",url:this.restUrl+"/"+a,isAsync:null!=c,asyncHandler:c})}};B.prototype._wrapAsync=
function(a){return new n(function(b){a.success(b)},function(b){a.fault(b)})};B.prototype.validatePlayPurchase=function(a,b,c,d){if(3>arguments.length)throw Error("Package Name, Product Id, Token must be provided and must be not an empty STRING!");for(var f=arguments.length-2;0<=f;f--)if(!arguments[f]||!g.isString(arguments[f]))throw Error("Package Name, Product Id, Token must be provided and must be not an empty STRING!");var f=l(arguments),k=null!=f;f&&(f=this._wrapAsync(f));return e._ajax({method:"GET",
url:this.restUrl+"/validate/"+a+"/inapp/"+b+"/purchases/"+c,isAsync:k,asyncHandler:f})};B.prototype.cancelPlaySubscription=function(a,b,c,d){if(3>arguments.length)throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");for(var f=arguments.length-2;0<=f;f--)if(!arguments[f]||!g.isString(arguments[f]))throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");var f=l(arguments),k=null!=f;f&&(f=this._wrapAsync(f));
return e._ajax({method:"POST",url:this.restUrl+"/"+a+"/subscription/"+b+"/purchases/"+c+"/cancel",isAsync:k,asyncHandler:f})};B.prototype.getPlaySubscriptionStatus=function(a,b,c,d){if(3>arguments.length)throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");for(var f=arguments.length-2;0<=f;f--)if(!arguments[f]||!g.isString(arguments[f]))throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");var f=l(arguments),
k=null!=f;f&&(f=this._wrapAsync(f));return e._ajax({method:"GET",url:this.restUrl+"/"+a+"/subscription/"+b+"/purchases/"+c,isAsync:k,asyncHandler:f})};H.prototype._wrapAsync=function(a){return new n(function(b){a.success(b)},function(b){a.fault(b)})};H.prototype.dispatch=function(a,b,c){if(!a||!g.isString(a))throw Error("Event Name must be provided and must be not an empty STRING!");b=g.isObject(b)?b:{};var d=l(arguments),f=null!=d;d&&(d=this._wrapAsync(d));b=b instanceof e.Async?{}:b;return e._ajax({method:"POST",
...
},cacheMethod:function(a,b,c,d){if(!g.isString(b))throw Error('The "key" argument must be String');var f=l(arguments),k=!1;null!=f&&(k=!0,f=this._wrapAsync(f));return e._ajax({method:a,url:e.serverURL+"/"+e.appVersion+"/cache/"+b+(c?"/check":""),isAsync:k,asyncHandler:f})},contains:function(a,b){return this.cacheMethod("GET",a,!0,b)},get:function(a,b){if(!g.isString(a))throw Error('The "key" argument must be String');var c=l(arguments),d=!1;null!=c&&(d=!0,c=this._wrapAsync(c));c=e._ajax({method:"GET",
url:e.serverURL+"/"+e.appVersion+"/cache/"+a,isAsync:d,asyncHandler:c});if(g.isObject(c)&&c.___class){var f;try{f=new (eval(c.___class))(c)}catch(k){f=new Y[c.___class](c)}return f}return c},remove:function(a,b){return this.cacheMethod("DELETE",a,!1,b)},setObjectFactory:function(a,b){Y[a]=b}};var s=function(){},Z=function(a){this.name=a};s.prototype={_wrapAsync:function(a){var b=this;return new n(function(c){c=b._parseResponse(c);a.success(c)},function(b){a.fault(b)})},_parseResponse:function(a){return a},
of:function(a){return new Z(a)},getConstructor:function(){return this},counterNameValidation:function(a,b){if(!a)throw Error('Missing value for the "counterName" argument. The argument must contain a string value.');if(!g.isString(a))throw Error('Invalid value for the "value" argument. The argument must contain only string values');this.name=a},implementMethod:function(a,b,c){var d=l(arguments),f=!1;null!=d&&(f=!0,d=this._wrapAsync(d));return e._ajax({method:a,url:e.serverURL+"/"+e.appVersion+"/counters/"+
...
a)}};S.prototype={invoke:function(a,b,c,d,f){var g=l(arguments),m=null!=g;return e._ajax({method:"POST",url:e.serverURL+"/"+e.appVersion+"/services/"+a+"/"+b+"/"+c,data:JSON.stringify(d),isAsync:m,asyncHandler:g})}};e.initApp=function(a,b,c){e.applicationId=a;e.secretKey=b;e.appVersion=c;e.appPath=[e.serverURL,e.appVersion].join("/");e.UserService=new W;e.Users=e.UserService;e.Geo=new L;e.Persistence=V;e.Data=V;e.Data.Permissions=new J;e.Messaging=new N;e.Files=new Q;e.Files.Permissions=new P;e.Commerce=
new B;e.Events=new H;e.Cache=new X;e.Counters=new s;e.CustomServices=new S;I={};q=null};m()||(module.exports=e)})();var BackendlessGeoQuery=function(){this.searchRectangle=void 0;this.categories=[];this.includeMetadata=!0;this.clusterGridSize=this.degreePerPixel=this.units=this.radius=this.longitude=this.latitude=this.pageSize=this.relativeFindPercentThreshold=this.relativeFindMetadata=this.condition=this.metadata=void 0};
BackendlessGeoQuery.prototype={addCategory:function(){this.categories=this.categories||[];this.categories.push()},setClusteringParams:function(m,t,n,u){u=u||0;m=parseFloat(m);t=parseFloat(t);n=parseInt(n);u=parseInt(u);if(!isFinite(m)||-180>m||180<m)throw Error("The westLongitude value must be a number in the range between -180 and 180");if(!isFinite(t)||-180>t||180<t)throw Error("The eastLongitude value must be a number in the range between -180 and 180");if(!isFinite(n)||1>n)throw Error("The mapWidth value must be a number greater or equal to 1");
if(!isFinite(u)||0>u)throw Error("The clusterGridSize value must be a number greater or equal to 0");m=t-m;0>m&&(m+=360);this.degreePerPixel=m/n;this.clusterGridSize=u||null}};
