...
function grantForUser(userId, url, asyncHandler) {
  return sendRequest.call(this.permission, PermissionTypes.GRANT, url, { userId }, asyncHandler)
}

function denyForUser(userId, url, asyncHandler) {
  return sendRequest.call(this.permission, PermissionTypes.DENY, url, { userId }, asyncHandler)
}

function grantForRole(roleName, url, asyncHandler) {
  return sendRequest.call(this.permission, PermissionTypes.GRANT, url, { roleName }, asyncHandler)
}

function denyForRole(roleName, url, asyncHandler) {
  return sendRequest.call(this.permission, PermissionTypes.DENY, url, { roleName }, asyncHandler)
}
